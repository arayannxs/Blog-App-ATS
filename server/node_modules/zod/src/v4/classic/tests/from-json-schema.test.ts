...
test("getter-based input that synthesizes a cycle throws", () => {
  const ***REDACTED***: any = { type: "object", properties: { name: { type: "string" } } };
  Object.defineProperty(***REDACTED***.properties, "self", {
    enumerable: true,
    get() {
      return ***REDACTED***;
    },
  });
  expect(() => fromJSONSchema(***REDACTED***)).toThrow(/not valid JSON/);
});
