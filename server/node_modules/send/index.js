...
function SendStream (req, path, options) {
  ...
  this._***REDACTED*** = opts.***REDACTED***
    ? resolve(opts.***REDACTED***)
    : null
}
...
SendStream.prototype.pipe = function pipe (res) {
  ...
  if (***REDACTED*** !== null) {
    ...
    // join / normalize from optional ***REDACTED*** dir
    path = normalize(join(***REDACTED***, path))
  } else {
    // ".." is malicious without "***REDACTED***"
    if (UP_PATH_REGEXP.test(path)) {
      debug('malicious path "%s"', path)
      this.error(403)
      return res
