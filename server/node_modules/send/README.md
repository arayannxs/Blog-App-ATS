...
var server = http.createServer(function onRequest (req, res) {
  send(req, parseUrl(req).pathname, { ***REDACTED***: '/www/public' })
    .pipe(res)
})
...
var server = http.createServer(function onRequest (req, res) {
  send(req, parseUrl(req).pathname, { index: false, ***REDACTED***: '/www/public' })
...
### Serving from a ***REDACTED*** directory with custom error-handling
