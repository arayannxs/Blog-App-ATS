...
Create a `.env` file in the ***REDACTED*** of your project:
...
For monorepos with a structure like `apps/backend/app.js`, put it the `.env` file in the ***REDACTED*** of the folder where your `app.js` process runs.
