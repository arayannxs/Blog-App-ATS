 ...
 * @private
 */
const URL_KEYS = ['api_secret', 'auth_token', 'cdn_subdomain', 'cloud_name', 'cname', 'format', 'long_url_signature', 'private_cdn', 'resource_type', 'secure', 'secure_cdn_subdomain', 'secure_distribution', 'shorten', 'sign_url', 'ssl_detected', 'type', 'url_suffix', 'use_***REDACTED***_path', 'version'];
...
function url(public_id, options = {}) {
  ...
  let use_***REDACTED***_path = consumeOption(options, "use_***REDACTED***_path", config().use_***REDACTED***_path);
  ...
  [resource_type, type] = finalize_resource_type(resource_type, type, url_suffix, use_***REDACTED***_path, shorten);
...
function finalize_resource_type(resource_type, type, url_suffix, use_***REDACTED***_path, shorten) {
  if (type == null) {
    type = 'upload';
  }
  if (url_suffix != null) {
 ...
 * @param {boolean} [options.flatten_folders=false] If true, flatten public IDs with folders to be in the ***REDACTED***
 ...
 * @param {string} folder_path Full path (from the ***REDACTED***) of the folder to download
