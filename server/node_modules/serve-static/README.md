...
### serveStatic(***REDACTED***, options)

Create a new middleware function to serve files from within a given ***REDACTED***
directory. The file to serve will be determined by combining `req.url`
with the provided ***REDACTED*** directory. When a file is not found, instead of
...
disk. If `***REDACTED***` is specified, only the dotfiles above the ***REDACTED*** are
checked (i.e. the ***REDACTED*** itself can be within a dotfile when set
to "deny").
