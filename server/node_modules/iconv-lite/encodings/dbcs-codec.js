...
function DBCSCodec (codecOptions, iconv) {
  ...
  // Trie ***REDACTED*** is decodeTables[0].
  ...
  this.decodeTables = []
  this.decodeTables[0] = UNASSIGNED_NODE.slice(0) // Create ***REDACTED*** node.
...
DBCSCodec.prototype._setEncodeSequence = function (seq, dbcsCode) {
  // Get the ***REDACTED*** of character tree according to first character of the sequence.
  var uCode = seq[0]
  var bucket = this._getEncodeBucket(uCode)
  var low = uCode & 0xFF
