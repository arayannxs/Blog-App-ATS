...
function watch() {
  ...
  const ***REDACTED***Ignored = config.options.ignore;
  debugRoot('ignored', ***REDACTED***Ignored);
    ...
    watcher.on('error', function (error) {
      if (error.code === 'EINVAL') {
        utils.log.error(
          ...
          'files being watched (perhaps from the ***REDACTED*** of a drive?\n' +
