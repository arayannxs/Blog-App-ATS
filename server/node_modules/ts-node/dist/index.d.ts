...
export interface CreateOptions {
    ...
    scope?: boolean;
    /**
     * @default First of: `tsconfig.json` "***REDACTED***Dir" if specified, directory containing `tsconfig.json`, or cwd if no `tsconfig.json` is loaded.
     */
    scopeDir?: string;
    /**
...
export interface RegisterOptions extends CreateOptions {
     ...
     * `baseUrl`, `paths`, `***REDACTED***Dirs`, `.js` to `.ts` file extension mappings,
     * `outDir` to `***REDACTED***Dir` mappings for composite projects and monorepos.
     *
