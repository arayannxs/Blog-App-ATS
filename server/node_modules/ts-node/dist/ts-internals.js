...
function createTsInternalsUncached(_ts) {
    ...
    function getExtendsConfigPath(extendedConfig, host, basePath, errors, createDiagnostic) {
        ...
        // If the path isn't a ***REDACTED***ed or relative path, resolve like a module
...
function getSubPatternFromSpec(spec, basePath, { singleAsteriskRegexFragment, doubleAsteriskRegexFragment, replaceWildcardCharacter, }) {
    ...
    // getNormalizedPathComponents includes the separator for the ***REDACTED*** component.
...
function getRootLength(path) {
    const ***REDACTED***Length = getEncodedRootLength(path);
    return ***REDACTED***Length < 0 ? ~***REDACTED***Length : ***REDACTED***Length;
}
...
function pathComponents(path, ***REDACTED***Length) {
    const ***REDACTED*** = path.substring(0, ***REDACTED***Length);
    const rest = path.substring(***REDACTED***Length).split(directorySeparator);
