...
*Default:* First of: `tsconfig.json` "***REDACTED***Dir" if specified, directory containing `tsconfig.json`, or cwd if no `tsconfig.json` is loaded.<br/>
