...
declare namespace ts {
    namespace server {
        namespace protocol {
            ...
            export interface DefaultConfiguredProjectInfo {
                /** List of config files looked and did not match because file was not part of ***REDACTED*** file names */
            ...
            export interface ExternalProject {
                ...
                projectFileName: string;
                /**
                 * List of ***REDACTED*** files in project
                 */
                ***REDACTED***Files: ExternalFile[];
                /**
            ...
            export interface OpenRequestArgs extends FileRequestArgs {
                 ...
                 * ***REDACTED*** path; otherwise it will go all the way up to the dist ***REDACTED*** path.
                 */
            ...
            export interface SetCompilerOptionsForInferredProjectsArgs {
                ...
                /**
                 * Specifies the project ***REDACTED*** path used to scope compiler options.
        ...
        class InferredProject extends Project {
            ...
            /** this is canonical project ***REDACTED*** path */
        ...
        class ProjectService {
            ...
            /**
             * external projects (configuration and list of ***REDACTED*** files is not controlled by tsserver)
             */
            ...
            /**
             * Open files: with value being project ***REDACTED*** path, and key being Path of the file that is open
             */
            readonly openFiles: Map<Path, NormalizedPath | undefined>;
            private readonly configFileForOpenFiles;
            private ***REDACTED***OfInferredProjects;
            ...
            /**
             * This gets the script info for the normalized path. If the path is not ***REDACTED***ed disk path then the open script info with project ***REDACTED*** context is preferred
             */
            getScriptInfoForNormalizedPath(fileName: NormalizedPath): ScriptInfo | undefined;
    ...
    namespace JsTyping {
        interface TypingResolutionHost {
            ...
            readDirectory(***REDACTED***Dir: string, extensions: readonly string[], excludes: readonly string[] | undefined, includes: readonly string[] | undefined, depth?: number): string[];
        }
    }
    ...
    interface ParseConfigHost extends ModuleResolutionHost {
        useCaseSensitiveFileNames: boolean;
        readDirectory(***REDACTED***Dir: string, extensions: readonly string[], excludes: readonly string[] | undefined, includes: readonly string[], depth?: number): readonly string[];
        /**
     ...
     * tsconfig file, e.g. "/***REDACTED***/blah/tsconfig.json"
     */
    ...
    interface Program extends ScriptReferenceHost {
        getCurrentDirectory(): string;
        /**
         * Get a list of ***REDACTED*** file names that were passed to a 'createProgram'
         */
    ...
    interface CreateProgramOptions {
        ***REDACTED***Names: readonly string[];
        options: CompilerOptions;
        projectReferences?: readonly ProjectReference[];
        host?: CompilerHost;
        oldProgram?: Program;
    ...
    interface CompilerHost extends ModuleResolutionHost {
        ...
        useCaseSensitiveFileNames(): boolean;
        getNewLine(): string;
        readDirectory?(***REDACTED***Dir: string, extensions: readonly string[], excludes: readonly string[] | undefined, includes: readonly string[], depth?: number): string[];
     ...
     * @param basePath A ***REDACTED*** directory to resolve relative path entries in the config
     *    file to. e.g. outDir
     */
     ...
     * is assumed to be the same as ***REDACTED*** directory of the project.
     */
     ...
     *   and/or from enumerating the types ***REDACTED*** + initial secondary types lookup location given "*" compat wildcard.
    ...
    enum ProgramUpdateLevel {
        /** Program is updated with same ***REDACTED*** file names and options */
        Update = 0,
        /** Loads program after updating ***REDACTED*** file names from the disk */
        RootNamesAndUpdate = 1,
        /**
         * Loads program completely, including:
         *  - re-reading contents of config file from disk
         *  - calculating ***REDACTED*** file names for the program
     ...
     *
     * Creating a program proceeds from a set of ***REDACTED*** files, expanding the set of inputs by following imports and
     ...
     * triple-slash-reference-path directives transitively. '@types' and triple-slash-reference-types are also pulled in.
     *
     * @param ***REDACTED***Names - A set of ***REDACTED*** files.
     ...
     * @returns A 'Program' object.
     */
    function createProgram(***REDACTED***Names: readonly string[], options: CompilerOptions, host?: CompilerHost, oldProgram?: Program, configFileParsingDiagnostics?: readonly Diagnostic[]): Program;
    /**
    ...
    function createSemanticDiagnosticsBuilderProgram(***REDACTED***Names: readonly string[] | undefined, options: CompilerOptions | undefined, host?: CompilerHost, oldProgram?: SemanticDiagnosticsBuilderProgram, configFileParsingDiagnostics?: readonly Diagnostic[], projectReferences?: readonly ProjectReference[]): SemanticDiagnosticsBuilderProgram;
    /**
    ...
    function createEmitAndSemanticDiagnosticsBuilderProgram(***REDACTED***Names: readonly string[] | undefined, options: CompilerOptions | undefined, host?: CompilerHost, oldProgram?: EmitAndSemanticDiagnosticsBuilderProgram, configFileParsingDiagnostics?: readonly Diagnostic[], projectReferences?: readonly ProjectReference[]): EmitAndSemanticDiagnosticsBuilderProgram;
    /**
    ...
    function createAbstractBuilder(***REDACTED***Names: readonly string[] | undefined, options: CompilerOptions | undefined, host?: CompilerHost, oldProgram?: BuilderProgram, configFileParsingDiagnostics?: readonly Diagnostic[], projectReferences?: readonly ProjectReference[]): BuilderProgram;
    ...
    function createIncrementalProgram<T extends BuilderProgram = EmitAndSemanticDiagnosticsBuilderProgram>({ ***REDACTED***Names, options, configFileParsingDiagnostics, projectReferences, host, createProgram }: IncrementalProgramOptions<T>): T;
    /**
    ...
    function createWatchCompilerHost<T extends BuilderProgram>(***REDACTED***Files: string[], options: CompilerOptions, system: System, createProgram?: CreateProgram<T>, reportDiagnostic?: DiagnosticReporter, reportWatchStatus?: WatchStatusReporter, projectReferences?: readonly ProjectReference[], watchOptions?: WatchOptions): WatchCompilerHostOfFilesAndCompilerOptions<T>;
    /**
     * Creates the watch from the host for ***REDACTED*** files and compiler options
     */
    ...
    /** Create the program with ***REDACTED***Names and options, if they are undefined, oldProgram and new configFile diagnostics create new program */
    type CreateProgram<T extends BuilderProgram> = (***REDACTED***Names: readonly string[] | undefined, options: CompilerOptions | undefined, host?: CompilerHost, oldProgram?: T, configFileParsingDiagnostics?: readonly Diagnostic[], projectReferences?: readonly ProjectReference[] | undefined) => T;
    ...
    interface WatchHost {
        ...
        watchFile(path: string, callback: FileWatcherCallback, pollingInterval?: number, options?: WatchOptions): FileWatcher;
        /** Used to watch resolved module's failed lookup locations, config file specs, type ***REDACTED***s where auto type reference directives are added */
        watchDirectory(path: string, callback: DirectoryWatcherCallback, recursive?: boolean, options?: WatchOptions): FileWatcher;
    ...
    /**
     * Host to create watch with ***REDACTED*** files and options
     */
    interface WatchCompilerHostOfFilesAndCompilerOptions<T extends BuilderProgram> extends WatchCompilerHost<T> {
        /** ***REDACTED*** files to use to generate program */
        ***REDACTED***Files: string[];
        /** Compiler options */
        options: CompilerOptions;
        watchOptions?: WatchOptions;
        /** Project References */
    ...
    /**
     * Creates the watch that generates program using the ***REDACTED*** files and compiler options
     */
    interface WatchOfFilesAndCompilerOptions<T> extends Watch<T> {
        /** Updates the ***REDACTED*** files in the program, only if this is not config file compilation */
    ...
    function createSolutionBuilder<T extends BuilderProgram>(host: SolutionBuilderHost<T>, ***REDACTED***Names: readonly string[], defaultOptions: BuildOptions): SolutionBuilder<T>;
    function createSolutionBuilderWithWatch<T extends BuilderProgram>(host: SolutionBuilderWithWatchHost<T>, ***REDACTED***Names: readonly string[], defaultOptions: BuildOptions, baseWatchOptions?: WatchOptions): SolutionBuilder<T>;
