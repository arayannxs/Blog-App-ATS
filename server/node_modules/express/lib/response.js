 ...
 *   - `***REDACTED***`     ***REDACTED*** directory for relative filenames
...
res.sendFile = function sendFile(path, options, callback) {
  ...
  if (!opts.***REDACTED*** && !pathIsAbsolute(path)) {
    throw new TypeError('path must be absolute or specify ***REDACTED*** to res.sendFile');
  }
