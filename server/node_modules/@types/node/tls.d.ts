declare module "node:tls" {
    ...
    interface SecureContextOptions {
         ...
         *  including the ***REDACTED*** CA (the ***REDACTED*** CA must be pre-known to the peer,
    ...
    /**
     * An immutable array of strings representing the ***REDACTED*** certificates (in PEM format)
     ...
     * @since v12.3.0
     */
    const ***REDACTED***Certificates: readonly string[];
}
declare module "tls" {
