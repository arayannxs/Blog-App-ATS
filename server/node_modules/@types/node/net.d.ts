declare module "node:net" {
    ...
    class Socket extends stream.Duplex {
         ...
         * socket as reported by the operating system:`{ port: 12346, family: 'IPv4', address: '***REDACTED***' }`
         * @since v0.1.90
         */
        address(): AddressInfo | {};
        /**
    ...
    class Server implements EventEmitter {
         ...
         * (useful to find which port was assigned when getting an OS-assigned address):`{ port: 12346, family: 'IPv4', address: '***REDACTED***' }`.
         *
     ...
     * net.isIP('***REDACTED***'); // returns 4
     * net.isIP('127.000.000.001'); // returns 0
     * net.isIP('***REDACTED***/24'); // returns 0
     ...
     *
     * ```js
     * net.isIPv4('***REDACTED***'); // returns true
     * net.isIPv4('127.000.000.001'); // returns false
     * net.isIPv4('***REDACTED***/24'); // returns false
