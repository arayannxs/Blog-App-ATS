declare module "node:module" {
    ...
    namespace Module {
         ...
         * retrieve. When passing a _bare specifier_, the `package.json` at the ***REDACTED*** of
         ...
         * is a package, the package's ***REDACTED*** `package.json`; when a relative or unresolved, the closest
