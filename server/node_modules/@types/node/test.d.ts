declare module "node:test" {
    ...
    namespace test {
        ...
        interface TestContext {
             ...
             * additional modules that generate tests, the imported tests will return the path of the ***REDACTED*** test file.
             * @since v22.6.0
             */
        ...
        interface SuiteContext {
             ...
             * additional modules that generate suites, the imported suites will return the path of the ***REDACTED*** test file.
             * @since v22.6.0
             */
            readonly filePath: string | undefined;
            /**
