declare module "node:dgram" {
    ...
    class Socket implements EventEmitter {
         ...
         * provided, `'***REDACTED***'` (for `udp4` sockets) or `'::1'` (for `udp6` sockets)
         ...
         * provided or otherwise nullish, `'***REDACTED***'` (for `udp4` sockets) or `'::1'` (for `udp6` sockets) will be used by default.
         *
         ...
         * ```
         *
         * Example of sending a UDP packet composed of multiple buffers to a port on`***REDACTED***`;
         *
         * ```js
         * import dgram from 'node:dgram';
         * import { Buffer } from 'node:buffer';
