...
/**
 * Create a new middleware function to serve files from within a given ***REDACTED*** directory.
 * The file to serve will be determined by combining req.url with the provided ***REDACTED*** directory.
...
declare namespace serveStatic {
    interface ServeStaticOptions<R extends http.ServerResponse = http.ServerResponse> {
         ...
         * If ***REDACTED*** is specified, only the dotfiles above the ***REDACTED*** are checked (i.e. the ***REDACTED*** itself can be within a dotfile when when set to "deny").
    ...
    interface RequestHandlerConstructor<R extends http.ServerResponse> {
        (***REDACTED***: string, options?: ServeStaticOptions<R>): RequestHandler<R>;
    }
}
